...
public class VirtualKeypad {
	...
	public final void resize(int w, int h) {
		...
		extraButtons.disable(prefs.getBoolean("disableExtraButtons", true) &&
				!prefs.getBoolean("sixButtonPad", false));
	...
	private static final float BUTTON_SIZE = 1.0f / 3;
	...
	private static final int[] BUTTONS = {
		Emulator.GAMEPAD_A, Emulator.GAMEPAD_B, Emulator.GAMEPAD_C,
	};

	private static final int[] EXTRA_BUTTONS = {
		Emulator.GAMEPAD_X, Emulator.GAMEPAD_Y, Emulator.GAMEPAD_Z,
	};
