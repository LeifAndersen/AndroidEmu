package com.androidemu.gg.input;
...
import com.androidemu.gg.R;
import com.androidemu.gg.wrapper.Wrapper;
...
public class VirtualKeypad {
	...
	private int getButtonsStates(float x, float y, float size) {
		if (size > multiButtonsPressThreshold)
			return (Emulator.GAMEPAD_BUTTON_1 | Emulator.GAMEPAD_BUTTON_2);

		return (x < 0.5f ?
				Emulator.GAMEPAD_BUTTON_1 : Emulator.GAMEPAD_BUTTON_2);
	}
