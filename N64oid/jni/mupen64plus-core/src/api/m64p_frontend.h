 ...
 */
typedef m64p_error (*ptr_CoreStartup)(int, const char *, void (*)(), void *, void (*)(void *, int, const char *), void *, void (*)(void *, m64p_core_param, int));
...
typedef void (*ptr_CoreSetGSButton)(int pressed);
...
typedef m64p_error (*ptr_CoreDeleteCheat)(const char *);
